...
contract ConfidentialTokenERCWithDepsScript is Script {
    ...
    function run() public {
        ...
        conf_token = new ConfidentialTokenERC(verifier, poseidon2, token, mpcAddress, mpc_pk1, mpc_pk2, mpc_pk3, true);
